...
warnings.warn(
    "The 'tokenizer/__init__' import path is deprecated; import from 'xrfm.tokenization' instead",
    DeprecationWarning,
    stacklevel=2,
)

from xrfm.tokenization import BPETokenizer, BytePairEncoder, Tokenizer, TokenizerInterface, encode_text, decode_text
