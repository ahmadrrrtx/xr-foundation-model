...
warnings.warn(
    "The 'training/distributed' import path is deprecated; import from 'xrfm.training' instead",
    DeprecationWarning,
    stacklevel=2,
)

from xrfm.training.distributed import *
from xrfm.training.distributed import xrfm_collate_fn, create_distributed_dataloader
