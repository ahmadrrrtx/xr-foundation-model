...
warnings.warn(
    "The 'training/__init__' import path is deprecated; import from 'xrfm.training' instead",
    DeprecationWarning,
    stacklevel=2,
)

from xrfm.training import Trainer, TrainingLoop, CheckpointLoader, OptimizerLoader, SchedulerLoader, MetricsWriter, xrfm_collate_fn, _set_seed
