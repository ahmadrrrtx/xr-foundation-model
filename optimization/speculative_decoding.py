...
warnings.warn(
    "The 'optimization/speculative_decoding' import path is deprecated; import from 'xrfm.optimization' instead",
    DeprecationWarning,
    stacklevel=2,
)

from xrfm.optimization.speculative_decoding import *
