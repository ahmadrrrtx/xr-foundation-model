...
"""Deprecated path: ``neurons`` → :mod:`xrfm.research.neurotopo`.
...
warnings.warn(
    "neurons is deprecated; import from xrfm.research.neurotopo instead",
    DeprecationWarning,
    stacklevel=2,
)

from xrfm.research.neurotopo.neurons.modules import NeuralModuleState
