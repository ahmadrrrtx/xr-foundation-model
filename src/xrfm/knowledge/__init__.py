...
"""Deprecated path: ``knowledge`` → :mod:`xrfm.research.neurotopo`.
...
warnings.warn(
    "knowledge is deprecated; import from xrfm.research.neurotopo instead",
    DeprecationWarning,
    stacklevel=2,
)

from xrfm.research.neurotopo.knowledge import *
