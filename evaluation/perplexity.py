...
warnings.warn(
    "The 'evaluation/perplexity' import path is deprecated; import from 'xrfm.evaluation' instead",
    DeprecationWarning,
    stacklevel=2,
)

from xrfm.evaluation.perplexity import compute_perplexity, compute_perplexity_strided, evaluate_checkpoint
