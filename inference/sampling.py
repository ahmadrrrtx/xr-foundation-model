...
warnings.warn(
    "The 'inference/sampling' import path is deprecated; import from 'xrfm.inference' instead",
    DeprecationWarning,
    stacklevel=2,
)

from xrfm.inference.sampling import sample_greedy, sample_temperature, sample_token, sample_top_k, sample_top_p
